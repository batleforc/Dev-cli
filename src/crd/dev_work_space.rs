...
// kopium command: kopium devworkspaces.workspace.devfile.io -A -D PartialEq
...
pub struct DevWorkspaceStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<DevWorkspaceStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
pub struct DevWorkspaceStatusConditions {
